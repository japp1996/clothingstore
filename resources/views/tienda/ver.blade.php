        	...
        	<div class="col-md-8">
        		<div class="container-texto">
        			...
        			<div class="container-description">
        				...
        				<p v-if="producto.collections != null" class="strong"><strong>@lang('Page.Tienda.Coleccion'):</strong> @if (\App::getLocale() == 'es') @{{ producto.collections.name }} @else @{{ producto.collections.name_english }} @endif</p>
