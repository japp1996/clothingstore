<template id="template-size-form">
    <div class="col s12">
        <div class="row">
            <div class="col s12">
        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12 center-align">
                    <label for="name" class="label-impegno">Nombre de la talla</label>
                ...
                <div class="col s12 m12 l12 margin-top center-align">
                    <a href="#!" class="btn btn-continue" @click="_store($event)" v-if="action == 0">Guardar</a>
                    <a href="#!" class="btn btn-continue" @click="_edit($event)" v-else>Actualizar</a>
                </div>
            </div>
        </div>
...
export default {
    ...
    created() {
       this.form = this.action != 0 ? this.data : {id: 0, name: ""}
    },
    ...
    methods: {
        ...
        _edit (e) {
            e.preventDefault();
            e.target.setAttribute('disabled', true)
            axios.put(`admin/sizes/${this.form.id}`, this.form)
            .then(res => {
                this._showAlert(res.data.message, "success")
                setTimeout(() => {
                    this.$emit('back', 0)
